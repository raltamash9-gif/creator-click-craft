        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-2">
          <Reveal>
            ...
            >
              ...
              <h3 className="mt-5 text-2xl font-bold tracking-[0.01em] lg:text-3xl">Individual Thumbnail</h3>
              ...
              <p className="mt-8 flex items-end gap-2">
                <span className="text-sm tracking-wide text-subtle">Starting from</span>
                <span className="font-display text-5xl font-extrabold tracking-[0.015em]">$50</span>
              </p>
          ...
          <Reveal delay={0.08}>
            ...
            >
              ...
              <div className="relative flex h-full flex-col">
                ...
                <h3 className="mt-5 text-2xl font-bold tracking-[0.01em] lg:text-3xl">Long-Term Collaboration</h3>
                <p className="mt-4 text-sm tracking-wide text-muted-foreground">
                  For creators uploading consistently who want one visual identity across
                  everything.
                </p>
                <p className="mt-8 font-display text-3xl font-extrabold tracking-[0.015em]">
